...
# %% auto 0
__all__ = ['device', 'Genome', 'Population', 'Trait', 'SimParams', 'scale_values', 'calculate_breeding_value',
           'truncation_selection', 'bv', 'create_pop', 'create_random_pop', 'update_pop', 'recombine', 'breed',
           'create_progeny', 'random_crosses', 'phenotype']
...
class SimParams:
    def __init__(self, founder_pop, config, seed=None):
        self.G = Genome(config['n_chr'],config['n_loci'])
        self.T = Trait(self.G, founder_pop, config['target_mean'], config['target_variance'])
        self.h2 = config['h2']
        self.reps = config['reps']
        self.pop_size = config['pop_size']
        self.max_generations = config['max_generations']
        self.founder_pop = founder_pop  # This is not in the config, you might want to add it or handle it differently
