...
# %% auto 0
__all__ = ['CustomFeatureExtractor', 'CustomNetwork', 'CustomActorCriticPolicy', 'MultiScalarFeatureExtractor',
           'MultiScalarPolicy']
...
class MultiScalarFeatureExtractor(BaseFeaturesExtractor):
    def __init__(self, observation_space: gym.spaces.Box, features_dim: int = 64):
        super(MultiScalarFeatureExtractor, self).__init__(observation_space, features_dim)
...
class MultiScalarPolicy(ActorCriticPolicy):
    def __init__(self, *args, **kwargs):
        super(MultiScalarPolicy, self).__init__(
            *args,
            **kwargs,
            features_extractor_class=MultiScalarFeatureExtractor,
