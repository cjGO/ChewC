...
d = { 'settings': { 'branch': 'main',
  ...
  'syms': { 'chewc.callback': { 'chewc.callback.ActionTrackingCallback': ('callback.html#actiontrackingcallback', 'chewc/callback.py'),
                                ...
                                'chewc.callback.AverageFinalGenerationCallback.on_training_end': ( 'callback.html#averagefinalgenerationcallback.on_training_end',
                                                                                                   'chewc/callback.py')},
            'chewc.gym': { 'chewc.gym.SelectionIntensityEnvironment': ('gym.html#selectionintensityenvironment', 'chewc/gym.py'),
                           'chewc.gym.SelectionIntensityEnvironment.__init__': ( 'gym.html#selectionintensityenvironment.__init__',
                                                                                 'chewc/gym.py'),
                           'chewc.gym.SelectionIntensityEnvironment._get_info': ( 'gym.html#selectionintensityenvironment._get_info',
                                                                                  'chewc/gym.py'),
                           'chewc.gym.SelectionIntensityEnvironment._get_obs': ( 'gym.html#selectionintensityenvironment._get_obs',
                                                                                 'chewc/gym.py'),
                           'chewc.gym.SelectionIntensityEnvironment.reset': ( 'gym.html#selectionintensityenvironment.reset',
                                                                              'chewc/gym.py'),
                           'chewc.gym.SelectionIntensityEnvironment.step': ('gym.html#selectionintensityenvironment.step', 'chewc/gym.py')},
